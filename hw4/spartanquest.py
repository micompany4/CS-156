...
Usage:  spartanquest.py maze_file search_algorihtm
...
Your task for homework 4 is to implement astar in informed_search.py.
...
class Problem(object):
    ...
    cost = {WEST: 1, SOUTH: 3, EAST: 5, NORTH: 4}
